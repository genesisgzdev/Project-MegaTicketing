...
Benchmark :: "parse"
  lukeed/ms      x 351,319 ops/sec Â±0.31% (96 runs sampled)
  zeit/ms        x 245,576 ops/sec Â±1.66% (94 runs sampled)

Benchmark :: "parse" (long)
  lukeed/ms      x 335,538 ops/sec Â±0.50% (94 runs sampled)
  zeit/ms        x 265,410 ops/sec Â±1.72% (95 runs sampled)
...
Benchmark :: "format"
  lukeed/ms      x 4,109,440 ops/sec Â±0.35% (94 runs sampled)
  zeit/ms        x 3,420,198 ops/sec Â±1.61% (94 runs sampled)

Benchmark :: "format" (long)
  lukeed/ms      x 3,402,872 ops/sec Â±0.14% (97 runs sampled)
  zeit/ms        x 1,344,908 ops/sec Â±3.68% (96 runs sampled)
```
